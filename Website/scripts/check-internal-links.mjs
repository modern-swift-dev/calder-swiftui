...
const hostingBasePath = "/calder-swiftui";
...
function resolveReference(sourceFile, reference) {
  ...
  return normalize(join(dirname(relative(outputDirectory, sourceFile)), referencePath));
}
...
async function resolvesToSiteContent(referencePath) {
  ...
  return exists(join(candidate, "index.html"));
}
